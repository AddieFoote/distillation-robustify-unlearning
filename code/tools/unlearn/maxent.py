        ...
        for step_in_epoch in range(steps_per_epoch):
            ...
            if use_retain and retain_loader_iter is not None:
                ...
                if use_repnoise:
                    ...
                    total_loss = (uniform_ce_forget + ce_loss_retain + repnoise_loss) / gradient_accumulation_steps
                else:
                    # Original loss calculation when RepNoise is disabled
                    total_loss = (uniform_ce_forget + ce_loss_retain) / gradient_accumulation_steps
            ...
            if (step_in_epoch + 1) % gradient_accumulation_steps == 0:
                ...
                if global_step == 1 or global_step % 5 == 0:
                    ...
                    if use_retain and retain_loader_iter is not None:
                        ...
                        print_acc(f"[maxent.py] Retain CE: {ce_loss_retain:.6f}", print_message)
