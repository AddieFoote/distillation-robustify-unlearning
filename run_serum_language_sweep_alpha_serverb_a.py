...
Launch Command (Sweep): python run_serum_language_sweep_alpha_serverb_a.py --run_all
Launch Command (Single): accelerate launch run_serum_language_sweep_alpha_serverb_a.py --setup gemma-2-0.1B_MaxEnt --alpha 0.1 --beta 0.5 --seed 111
accelerate launch run_serum_language_sweep_alpha_serverb_a.py --setup gemma-2-0.1B_MaxEnt --alpha 0.3 --beta 0.5 --seed 111
accelerate launch run_serum_language_sweep_alpha_serverb_a.py --setup gemma-2-0.1B_MaxEnt --alpha 0.7 --beta 0.05 --seed 111
"""
...
SWEEP_ALPHAS = [0.1, 0.3]  # Alpha values to sweep through
SWEEP_BETAS = [0.5]  # Beta values to sweep through (default is 0.1)
