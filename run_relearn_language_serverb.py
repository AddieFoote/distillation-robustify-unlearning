...
MODELS_TO_RUN = [
    ...
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.1-beta_0.5-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.3-beta_0.5-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.5-beta_0.5-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.7-beta_0.5-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.1-beta_1.0-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.3-beta_1.0-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.5-beta_1.0-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.7-beta_1.0-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.1-beta_0.05-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.3-beta_0.05-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.5-beta_0.05-seed_111',  # SERUM
    #'serum_models/gemma-2-0.1B_MaxEnt-language-SERUM-alpha_0.7-beta_0.05-seed_111',  # SERUM

    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_1.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_2.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_3.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_4.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_5.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_6.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_7.0e-05',
    'unlearned_models/RMU_SAM/gemma-2-0.1B_eng+kor_rho0.01_lr_8.0e-05',
]
...
#LR_RANGES = {
#    "GradDiff": [5e-5, 6e-5, 7e-5, 8e-5],
#    "MaxEnt": [5e-5, 6e-5, 7e-5, 8e-5],
#    "RMU": [5e-5, 6e-5, 7e-5, 8e-5]
#}
